...
class HotelBookingModelWrapper(mlflow.pyfunc.PythonModel):
    ...
    def log_register_model(self, wrapped_model_info: ModelInfo, pyfunc_model_name: str,
                           experiment_name: str, tags: Tags, code_paths: list) -> None:
        ...
        input_example = pd.DataFrame(input_example_dict['data'],
                                     columns=input_example_dict['columns'])
        additional_pip_deps = []
